...
use Connecteev\Mailgun\Mail\Mailer;
use Closure;
...
class Service implements MailgunContract
{
    ...
    /**
     * @var \Connecteev\Mailgun\Mail\Mailer
     */
    protected $mailer;
     ...
     *
     * @return \Connecteev\Mailgun\Http\Response
     */
     ...
     *
     * @return \Connecteev\Mailgun\Validation\Validator
     */
